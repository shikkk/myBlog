...
- 主要信息：男 / 未婚  / 1994.02 / 5年工作经验

  

### 个人概括

* 本人先后就职于敦煌网、猎豹移动、澎思科技、先胜业财。期间做过 B2C 跨境电商项目、跨境 ERP 系统、BI 报表系统、人工智能人脸识别管理系统，业财务一体化大型SaaS系统；也做过微信二次开发、微信小程序和钉钉二次开发。
* 有大型微前端SaaS平台经验，跨团队协同能力强，对前端性能化有一定的应用和思考；
* 注重前端标准化，在部门内推行 Eslint CommitLint及标准落地；
* 熟练使用并深入理解Vue及其生态，并研究过其内部 部分核心api的实现；
* 熟练使用 React-hooks、TypeScript；
* 熟练使用 Antd、iView、ElementUi等UI框架；
* 熟练使用 echarts.js、AntdV等可视化工具；
* 熟练使用 vite 、webpack 等自动化构建工具；
...
- 负责开发单据模板、日记账报告、工作底稿、合并算法、对账等低代码子系统组件
...
#### 北京澎思科技
##### 离职原因：AIOT部门业务调整，业务线相关项目裁员

- **高级前端工程师**（2020.08 \~ 2021.05）
...
* 网址：https://www.deepfinance.com/

- 背景：业财一体化数据智能管理平台，低代码开发平台。

- 核心技术：single-spa-react微前端 、React-Hooks+ts+antd、ahook

- 核心工作：

  - 负责日记账模板、日记账报告、工作底稿、合并算法子系统开发

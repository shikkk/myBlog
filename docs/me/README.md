...
* 本人有5年左右前端开发经验，先后就职于敦煌网、猎豹移动、澎思科技、先胜业财。期间做过 B2C 跨境电商项目、跨境 ERP 系统、BI 报表系统、人工智能人脸识别管理系统，业财务一体化SaaS系统;也做过微信二次开发、微信小程序和钉钉二次开发。
* 熟练使用前端 MVVM 框架 Vue.js，研究和学习其核心Api的实现原理；
...
- 负责开发日记账模板、日记账报告、工作底稿、合并算法子系统组件
...
#### 北京澎思科技
##### 离职原因：公司裁员50%，前端组全裁，不知道现在这公司还在不在
...
- 核心技术：single-spa-react微服务 、React-Hooks+ts+antd、ahook
